  ...
  return (
    <ContentContainer>
      <div className="py-8 lg:flex">
        ...
        <div className="flex justify-center sm:ps-8 lg:justify-start xl:text-xl xl:w-2/4">
          <div className="flex flex-wrap items-center gap-4 sm:block">
            <IconContext.Provider value={{ size: 40, color: "#FFC612" }} >
              ...
              <div className="flex sm:gap-4 items-center sm:mb-6">
              ...
              <a href={"https://github.com/Kike0013"} target='_blank' className="flex gap-3 sm:mb-6 hover:text-[#FFC612] w-fit items-center">
                <BsGithub /> <span className="hidden sm:block">https://github.com/Kike0013</span>
              </a>
              <a href={"https://mellarafael.vercel.app/"} target='_blank' className="flex gap-3 sm:mb-6 hover:text-[#FFC612] w-fit items-center">
